...
;x           F4 - Terminates active application after confirmation.
;                This is like using the Ctrl+Alt+Delete menu.
;x     SHIFT F4 - As above, but skips confirmation window.
...
;x            L - Launch (run) a script selected in explorer.
...
;x            T - Makes the active window 50% transpartent.
;x      SHIFT T - Makes the active window opaque again.
;x winv            V - Pastes clipboard contents as plain text (if possible).
